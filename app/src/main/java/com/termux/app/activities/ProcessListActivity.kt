...
import com.termux.app.compose.ProcessListScreen

class ProcessListActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            CompositionLocalProvider(
                ...
                KiTerminalTheme {
                    ProcessListScreen(navBarBottomPadding = Dp(0f), onBackPressed = { finish() })
                }
            }
        }
    }
