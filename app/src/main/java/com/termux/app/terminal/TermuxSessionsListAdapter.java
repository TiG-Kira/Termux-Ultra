...
public class TermuxSessionsListAdapter extends ArrayAdapter<TermuxSession> {
    ...
    private final boolean mIsBlackUI;

    public TermuxSessionsListAdapter(Context context, List<TermuxSession> sessionList, boolean isBlackUI) {
        super(context, R.layout.item_terminal_sessions_list, sessionList);
        this.mIsBlackUI = isBlackUI;
    }
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (mIsBlackUI) {
            sessionTitleView.setBackground(
                ContextCompat.getDrawable(getContext(), R.drawable.session_background_black_selected)
            );
        }
        ...
        int defaultColor = mIsBlackUI ? Color.WHITE : Color.BLACK;
