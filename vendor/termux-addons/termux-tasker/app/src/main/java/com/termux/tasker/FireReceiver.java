...
public final class FireReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        // Use the context's actual package name so this works both when the plugin is compiled as a
        // standalone APK (package com.termux.tasker) and when integrated as a library module into
        // the host Termux app (package com.termux).
        executionIntent.setClassName(context.getPackageName(), Constants.TERMUX_SERVICE);
